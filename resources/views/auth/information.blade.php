...
<aside class="profile-card">
    ...
    <header >
        ...
        <!-- here’s the avatar -->
        <a href="/">
            <img src="{{asset($students[0]->avatar)}}" />
        </a>
    ...
    <ul class="profile-social-links">
        ...
        <li class="text-center col-6">
            <a href="#"  data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Profile">
                <svg  stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M13.0207 5.82839L15.8491 2.99996L20.7988 7.94971L17.9704 10.7781M13.0207 5.82839L3.41405 15.435C3.22652 15.6225 3.12116 15.8769 3.12116 16.1421V20.6776H7.65669C7.92191 20.6776 8.17626 20.5723 8.3638 20.3847L17.9704 10.7781M13.0207 5.82839L17.9704 10.7781" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
        </li>
