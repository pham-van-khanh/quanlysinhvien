    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
           target="_blank">
            ...
            <span class="ms-1 font-weight-bold text-white">@lang('welcome.title')</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('faculties.index') }}">
                    ...
                    <span class="nav-link-text ms-1">@lang('welcome.faculty')</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('subjects.index') }}">
                    ...
                    <span class="nav-link-text ms-1">@lang('welcome.subject')</span>
                </a>
            </li>
            @can('create')
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('students.index') }}">
                        ...
                        <span class="nav-link-text ms-1">@lang('welcome.student')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('users.index') }}">
                        ...
                        <span class="nav-link-text ms-1">@lang('welcome.user')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('roles.index') }}">
                        ...
                        <span class="nav-link-text ms-1">@lang('welcome.role')</span>
                    </a>
                </li>
    @endcan
</aside>
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    ...
                    <li class="nav-item px-3 d-flex align-items-center">
                        ...
                        @else
                            <a class="nav-link" href="{{route('information', Auth::user()->id)}}">
